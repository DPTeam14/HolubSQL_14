...
public class SelectStarOnJoinTest {
    ...
    @Test
    public void testSelectStarOnJoin() {
        ...
        // 정답 준비
        String answer =
        "addrId    street    city      state     zip       first     last      addrId    \n"    +
        "--------- --------- --------- --------- --------- --------- --------- --------- \n"    +
        "0         12 MyStreetBerkeley  CA        99998     Allen     Holub     0         \n"   +
        "1         34 Quarry Ln.Bedrock   AZ        00000     Fred      Flintstone1         \n" +
        "1         34 Quarry Ln.Bedrock   AZ        00000     Wilma     Flintstone1         \n";
        ...
        try {
            // 실제 쿼리 테스트 수행
            results = statement.executeQuery("select * from address, name where address.addrId = name.addrId");
